...
# Solving Unity ML-Agents Environment "Tennis" with MADDPG

## Task Details

The task is to solve [Tennis](https://github.com/Unity-Technologies/ml-agents/blob/master/docs/Learning-Environment-Examples.md#tennis) environment.
...
3. run `conda create -n tennis python=3.8`
4. run `conda activate tennis`
5. at 'unityagents_installation' directory, run `pip install .`
6. at project root directory run `bash install_dependencies.sh`

## Instructions

* `python train.py`: trains agent and saves it to 'agent.ckpt'
